...
struct Session
{
	Session(asio::io_service &ios,
					...
					unsigned int id, Callback callback) : m_sock(ios),
...
int main()
{
	try
	{
		...
		client.emulateLongComputationOp(10, "127.0.0.1", 8001, handler, 1);
		// Then does nothing for 5 seconds.
		std::this_thread::sleep_for(std::chrono::seconds(5));
		// Then initiates another request with id 2.
		client.emulateLongComputationOp(11, "127.0.0.1", 8002, handler, 2);
		...
		client.emulateLongComputationOp(12, "127.0.0.1", 8003, handler, 3);
